...
void CFiguras::prisma3(GLuint text, GLuint text2)  //Funcion creacion casa
{

	GLfloat vertice[10][3] = {
				{2.0 ,-1.0, 2.0},    //Coordenadas Vértice 0 V0
				{7.0 ,-1.0, 2.0},    //Coordenadas Vértice 1 V1
				{7.0 ,-1.0, 0.25},    //Coordenadas Vértice 2 V2
				{2.0 ,-1.0, 0.25},    //Coordenadas Vértice 3 V3
				{2.0 ,-3.4, -0.75},    //Coordenadas Vértice 4 V4
				{2.0 ,-5.8, 0.25},    //Coordenadas Vértice 5 V5
				{2.0 ,-5.8, 2.0},    //Coordenadas Vértice 6 V6
				{7.0 ,-5.8, 2.0},    //Coordenadas Vértice 7 V7
				{7.0 ,-5.8, 0.25},	   //Coordenadas Vértice 7 V8
				{7.0 ,-3.4, -0.75},		   //Coordenadas Vértice 7 V9
	...
	glBegin(GL_POLYGON);	//Lateral Izquierda
		//glColor3f(0.0,0.0,1.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	...
	glBegin(GL_POLYGON);	//Lateral Derecha
	//glColor3f(0.0,0.0,1.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[2]);
...
void CFiguras::prisma4(GLuint text, GLuint text2)  //Funcion creacion contornos
{
	...
	glBindTexture(GL_TEXTURE_2D, text2);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Tejado contorno frontal
	//glColor3f(0.0, 0.0, 1.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[0]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[1]);
	...
	glBegin(GL_POLYGON);	//Tejado contorno izquierdo
	...
	glBegin(GL_POLYGON);	//Tejado contorno derecho
	//glColor3f(1.0, 0.0, 0.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[1]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[2]);
	...
	glBegin(GL_POLYGON);	//Tejado contorno trasero
	//glColor3f(1.0, 0.0, 0.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
...
void CFiguras::prisma5(GLuint text, GLuint text2)  //Funcion creacion prisma
{
	...
	glBindTexture(GL_TEXTURE_2D, text2);   // choose the texture to use.
	glBegin(GL_POLYGON);	//Tejado cara frontal
	...
	glBegin(GL_POLYGON);	//Tejado cara trasera
	//glColor3f(1.0, 1.0, 0.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	...
	glBegin(GL_POLYGON);	//Tejado cara frontal superior
	//glColor3f(1.0, 1.0, 0.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[2]);
	glTexCoord2f(1.0f, 0.0f); glVertex3fv(vertice[3]);
	...
	glBegin(GL_POLYGON);	//Tejado cara trasera superior
	//glColor3f(1.0, 1.0, 0.0);
	glNormal3f(1.0f, 0.0f, 0.0f);
	glTexCoord2f(0.0f, 0.0f); glVertex3fv(vertice[6]);
